        ...
        <div>
            ...
            <main>
                <nav className="px-6 pt-4 text-xs text-neutral-500">
                    ...
                    {" / "}
                    <a href="/shoe" className="text-blue-700 hover:underline">New In</a>
                    {" / "}
                    <span>Womens Shoe</span>
                </nav>

                <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 px-6 pb-2">
                    {shoeCategories.map((label) => (
...
export default ShoeAccessories;