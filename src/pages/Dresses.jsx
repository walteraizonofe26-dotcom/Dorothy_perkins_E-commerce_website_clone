...
const dressesCategories = [
  { name: "Dresses", image: "/images/sale8.jpg" },
  { name: "Tops", image: "/images/sale7.jpg" },
  { name: "Coats & Jackets", image: "/images/sale6.jpg" },
  { name: "Skirts", image: "/images/sale5.jpg" },
  { name: "Trousers", image: "/images/sale4.jpg" },
  { name: "Petite", image: "/images/sale3.jpg" },
  { name: "Knitwear", image: "/images/sale2.jpg" },
  { name: "Shoes", image: "/images/sale19.jpg" },
];
    ...
    <div>
      ...
      <main>
        ...
        <div className="px-6 pb-2 pt-4 text-center">
          <h1 className="text-2xl font-bold">Women Dresses</h1>
          <p className="text-sm text-green-700">1,000+ products</p>
        </div>

        <CategoryCarousel categories={dressesCategories} />
        <ProductFilters />
        <ProductGrid products={dressesProducts} />
      </main>
