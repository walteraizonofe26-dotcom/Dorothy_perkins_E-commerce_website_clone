...
const petiteCategories = [
    "Petite Coat & Jackets",
    "Petite KnitWear",
    "Petite Trouser & Leggings",
    "Petite Dresses",
    "Petite Playsuits & Jumpsuits",
    " Petite Jeans ",
    "Petite Skirts ",
    " Petite Tops & T-Shirts ",
    "Sale Petite Clothing  ",
];

   
// 15 New In products
const petiteProducts = [
